...
Numbers and date-times are two examples of continuous variables. You can visualize the distribution of a continuous variable with a histogram, like the one below, depicting the eruption time (in minutes) of old faithful, a well-known geyser in Yellowstone National Park:
...
The geyser erupts with semi-regular intervals, its timing is influenced by the duration of the previous eruption: shorter eruptions are followed by shorter intervals, while longer eruptions lead to longer intervals between eruptions. 

![](img/old-faithful-yellowstone.jpg){width="35%" fig-align="center"}

This characteristic pattern has made Old Faithful a subject of interest in statistics, often used as a dataset to study bimodal distributions, as the eruption intervals tend to cluster into two primary groups, around shorter and longer wait times.This characteristic pattern has made Old Faithful a subject of interest in statistics, often used as a dataset to study bimodal distributions, as the eruption intervals tend to cluster into two primary groups, around shorter and longer wait times.
